...
public interface IAppointmentService
{
    ...
    Task<ServiceResult<IEnumerable<ServiceDto>>> GetAllServicesAsync(bool includeInactive = true);
    Task<ServiceResult<ServiceDto>> GetServiceByIdAsync(Guid serviceId, bool includeInactive = true);
    ...
    Task<ServiceResult<IEnumerable<AppointmentServiceItemResponseDto>>> GetAppointmentSelectedServicesAsync(Guid appointmentId, Guid userId, string userRole);
